    ...
    [995, 26, 534, 369, 804, 888, 680, 121, 288, 42, 50, 985, 287, 824, 58, 114, 443, 838, 685, 858, 102, 1, 124, 859, 979, 497, 800, 149, 153, 356, 495, 157, 244, 209, 188, 699], {
        ...
        9318: (e, t, n) => {
            ...
            class MegaMenu extends elementorModules.frontend.handlers.NestedTabs {
                ...
                deactivateActiveTab() {
                    ...
                    this.setTabDeactivationAttributes(i), o.removeClass(t), o[e.hideTabFn](0, (() => this.onHideTabContent(o))), this.removeAnimationFromContentIfNeeded(), r.removeClass(t), elementorFrontend.isEditMode() && o.length && this.observedContainer ? .unobserve(o[0]), this.menuHeightController.resetMenuHeight(o)
                }
                ...
                onTabClick(e) {
                    ...
                    if (t || n) return;
                    const s = e ? .target ? .closest(".elementor-widget-n-menu") ? .getAttribute("data-id");
        ...
        6921: (e, t) => {
            ...
            class MenuTitleKeyboardHandler extends elementorModules.frontend.handlers.Base {
                __construct() {
                    super.__construct(...arguments), this.focusableElementSelector = "audio, button, canvas, details, iframe, input, select, summary, textarea, video, [accesskey], [contenteditable], a[href], area[href], [tabindex]", this.handleMenuToggleKeydown = this.handleMenuToggleKeydown.bind(this)
                }
                getDefaultSettings() {
                    return {
                        selectors: {
                ...
                bindEvents() {
                    this.elements.$menuItemElements.on(this.getTitleEvents()), this.elements.$focusableContainerElements.on(this.getContentElementEvents()), this.elements.$menuToggle.on("keydown", this.handleMenuToggleKeydown)
                }
                unbindEvents() {
                    this.elements.$menuItemElements.off(), this.elements.$focusableContainerElements.off(this.getContentElementEvents()), this.elements.$menuToggle.off("keydown", this.handleMenuToggleKeydown)
                }
                ...
                handleTitleKeyboardNavigation(e) {
                    switch (e.key) {
                        case "Tab":
                            e.shiftKey ? this.closeActiveContentElements() : this.handleTitleTab(e);
                            break;
                        case "Home":
                        case "End":
                ...
                handleTitleTab(e) {
                    ...
                    const n = this.getActiveTitleElement(),
                        ...
                        i = n.attr(this.getSettings("ariaAttributes").titleControlAttribute),
                        o = this.elements.$itemContainers.filter(`#${i}`),
                        r = 0 !== this.getFocusableElements(o).length;
                    s && r ? this.focusFirstFocusableContainerElement(e, i) : this.closeActiveContentElements()
                }
                maybeFocusMenuToggle(e, t) {
                    ...
                    const n = this.getSettings("ariaAttributes").titleStateAttribute,
                        ...
                        i = 0 !== this.getFocusableElements(this.elements.$itemContainers.last()).length;
                    s && i || (this.setFocusToMenuToggle(), e.preventDefault(), e.stopPropagation())
                }
                ...
                setTitleFocus(e) {
                    this.elements.$menuItemElements.filter(this.getTitleFilterSelector(e)).trigger("focus")
                }
                isLastTitle(e) {
                ...
                focusFirstFocusableContainerElement(e, t) {
                    ...
                    0 !== i.length && (e.preventDefault(), i[0] ? .focus(), e.stopPropagation())
                }
        ...
        1699: function(e) {
            e.exports = function() {
                ...
                const b = o(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]),
                    ...
                    A = o(["xlink:href", "xml:id", "xlink:title", "xml:space", "xmlns:xlink"]),
                    x = r(/\{\{[\w\W]*|[\w\W]*\}\}/gm),
                    D = r(/<%[\w\W]*|[\w\W]*%>/gm),
                    L = r(/\${[\w\W]*}/gm),
                    O = r(/^data-[\-\w.\u00B7-\uFFFF]/),
                ...
                function createDOMPurify() {
                    ...
                    const it = function _checkValidNamespace(e) {
                        ...
                        at = function _initDocument(e) {
                            ...
                            "application/xhtml+xml" === Ue && je === Ne && (e = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>' + e + "</body></html>");
                            ...
                            return e && n && o.insertBefore(i.createTextNode(n), o.childNodes[0] || null), je === Ne ? X.call(t, Se ? "html" : "body")[0] : Se ? t.documentElement : o
                        },
                        lt = function _createIterator(e) {
                            return K.call(e.ownerDocument || e, e, x.SHOW_ELEMENT | x.SHOW_COMMENT | x.SHOW_TEXT, null, !1)
                        },
                        ...
                        ht = function _isValidAttribute(e, t, n) {
                            if (Te && ("id" === t || "name" === t) && (n in i || n in Ye)) return !1;
                            if (fe && !ge[t] && y(se, t));
                            else if (pe && y(ie, t));
                            else if (!ce[t] || ge[t]) {
                        ...
                        pt = function _sanitizeAttributes(e) {
                            ...
                            for (i = o.length; i--;) {
                                ...
                                if (ht(d, s, n)) {
                                    if (!Fe || "id" !== s && "name" !== s || (rt(a, e), n = Me + n), V && "object" == typeof P && "function" == typeof P.getAttributeType)
                                        if (l);
                    ...
                    return DOMPurify.sanitize = function(e) {
                        ...
                        if (Ce) {
                            if ($e)
                                for (o = Y.call(t.ownerDocument); t.firstChild;) o.appendChild(t.firstChild);
                            else o = t;
                            return (ce.shadowroot || ce.shadowrootmod) && (o = J.call(n, o, !0)), o
                        }
                        let c = Se ? t.outerHTML : t.innerHTML;
                        return Se && le["!doctype"] && t.ownerDocument && t.ownerDocument.doctype && t.ownerDocument.doctype.name && y(N, t.ownerDocument.doctype.name) && (c = "<!DOCTYPE " + t.ownerDocument.doctype.name + ">\n" + c), ye && (c = f(c, ee, " "), c = f(c, te, " "), c = f(c, ne, " ")), V && Ee ? V.createHTML(c) : c
